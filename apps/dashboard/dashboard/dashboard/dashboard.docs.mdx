---
labels: ['dashboard-service', 'platform', 'composition', 'apps']
...
You can introduce new micro-services or micro-frontends to the platform by composing the in the `dashboard.bit-app.ts`:
