      ...
      >
        ...
        >
          <ServerCardButton
            ...
            onClick={(e) => handleServerCardButtonClick(e, "power")}
          />
          <ServerCardButton
            icon={Terminal}
            className={cn(
            ...
            onClick={(e) => handleServerCardButtonClick(e, "console")}
          />
          <ServerCardButton
            icon={FolderOpen}
            className={cn(
            ...
            onClick={(e) => handleServerCardButtonClick(e, "files")}
          />
          <ServerCardButton
            icon={Settings}
            className={cn(
            ...
            onClick={(e) => handleServerCardButtonClick(e, "settings")}
          />
        </div>
      </Card>
    </Link>
