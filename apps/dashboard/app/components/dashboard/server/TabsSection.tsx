    ...
    <Card className="border-border bg-server-card shadow-sm overflow-hidden rounded-xl py-0">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-4 rounded-none border-b border-border bg-transparent p-0 h-12 no-select">
          <SectionTabsTrigger value="console" activeTab={activeTab}>
            <Terminal className="mr-2 h-4 w-4" />
          </SectionTabsTrigger>
          <SectionTabsTrigger value="files" activeTab={activeTab}>
            <HardDrive className="mr-2 h-4 w-4" />
          </SectionTabsTrigger>
          <SectionTabsTrigger value="activity" activeTab={activeTab}>
            <Activity className="mr-2 h-4 w-4" />
          </SectionTabsTrigger>
          <SectionTabsTrigger value="settings" activeTab={activeTab}>
