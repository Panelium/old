...
export function FileManager({
  ...
  const handleCreateNewFile = () => {
    console.log(
      `Creating new file: ${newFileName} with content length: ${newFileContent.length}`
    );
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead onClick={() => handleSortChange("name")}>
                  ...
                  <TableHead onClick={() => handleSortChange("size")}>
                    <div className="flex items-center">
                      Size
                      {sortBy === "size" && (
                        <ChevronDown
                  ...
                  <TableHead onClick={() => handleSortChange("modified")}>
                    <div className="flex items-center">
                      Last Modified
                      {sortBy === "modified" && (
                        <ChevronDown
                    ...
                    <ContextMenu key={file.name}>
                      <ContextMenuTrigger asChild>
                        ...
                        >
                          ...
                          <TableCell className="p-2">
                            <div className="flex items-center gap-2">
                              <file.icon className="h-4 w-4 text-slate-500 dark:text-slate-400 flex-shrink-0" />
                              <span>{file.name}</span>
                            </div>
                          </TableCell>
                          <TableCell className="p-2 text-slate-500 dark:text-slate-400 text-sm">
                            {file.type === "folder"
                              ? `${file.items} items`
                              : file.size}
                          </TableCell>
                    ...
                    <ContextMenuTrigger asChild>
                      ...
                      >
                        <div className="relative mb-2">
                          <file.icon className="h-10 w-10 text-slate-500 dark:text-slate-400" />
                          {selectedFiles.includes(file.name) && (
