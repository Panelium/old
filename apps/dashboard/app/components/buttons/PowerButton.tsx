...
const PowerActionButtonStyleMap: Record<PowerAction, string> = {
  ...
  [PowerAction.RESTART]: "",
  [PowerAction.STOP]:
    "text-rose-700 dark:text-rose-300 hover:bg-rose-100 dark:hover:bg-rose-900/20 hover:text-rose-700 border-rose-200 dark:border-rose-900/20",
  [PowerAction.KILL]:
    "text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/20 hover:text-red-700 border-red-200 dark:border-red-900/20",
};
