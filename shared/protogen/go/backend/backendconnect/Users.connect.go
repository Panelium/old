...
const (
	...
	UsersServiceName = "backend.UsersService"
)

// UsersServiceClient is a client for the backend.UsersService service.
type UsersServiceClient interface {
}

// NewUsersServiceClient constructs a client for the backend.UsersService service. By default, it
...
// UsersServiceHandler is an implementation of the backend.UsersService service.
...
func NewUsersServiceHandler(svc UsersServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	return "/backend.UsersService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		default:
			http.NotFound(w, r)
		}
