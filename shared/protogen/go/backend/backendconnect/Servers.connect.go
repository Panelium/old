...
const (
	...
	ServersServiceName = "backend.ServersService"
)

// ServersServiceClient is a client for the backend.ServersService service.
type ServersServiceClient interface {
}

// NewServersServiceClient constructs a client for the backend.ServersService service. By default,
...
// ServersServiceHandler is an implementation of the backend.ServersService service.
...
func NewServersServiceHandler(svc ServersServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	return "/backend.ServersService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		default:
			http.NotFound(w, r)
		}
