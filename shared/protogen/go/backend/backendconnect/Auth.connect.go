...
type AuthServiceClient interface {
	Register(context.Context, *connect.Request[backend.RegisterRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error)
	Login(context.Context, *connect.Request[backend.LoginRequest]) (*connect.Response[backend.LoginResponse], error)
	ChangePassword(context.Context, *connect.Request[backend.ChangePasswordRequest]) (*connect.Response[backend.ChangePasswordResponse], error)
	ChangePasswordRequestMFACode(context.Context, *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error)
	ChangePasswordVerifyMFA(context.Context, *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error)
	RequestPasswordReset(context.Context, *connect.Request[backend.RequestPasswordResetRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error)
	ResetPassword(context.Context, *connect.Request[backend.ResetPasswordRequest]) (*connect.Response[backend.ResetPasswordResponse], error)
	ResetPasswordRequestMFACode(context.Context, *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error)
	ResetPasswordVerifyMFA(context.Context, *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error)
	RequestMFACode(context.Context, *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error)
	VerifyMFA(context.Context, *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error)
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := backend.File_backend_Auth_proto.Services().ByName("AuthService").Methods()
	return &authServiceClient{
		register: connect.NewClient[backend.RegisterRequest, proto_gen_go.SuccessMessage](
			httpClient,
			baseURL+AuthServiceRegisterProcedure,
			connect.WithSchema(authServiceMethods.ByName("Register")),
			connect.WithClientOptions(opts...),
		),
		login: connect.NewClient[backend.LoginRequest, backend.LoginResponse](
			httpClient,
			baseURL+AuthServiceLoginProcedure,
			connect.WithSchema(authServiceMethods.ByName("Login")),
			connect.WithClientOptions(opts...),
		),
		changePassword: connect.NewClient[backend.ChangePasswordRequest, backend.ChangePasswordResponse](
			httpClient,
			baseURL+AuthServiceChangePasswordProcedure,
			connect.WithSchema(authServiceMethods.ByName("ChangePassword")),
			connect.WithClientOptions(opts...),
		),
		changePasswordRequestMFACode: connect.NewClient[backend.RequestMFACodeRequest, proto_gen_go.SuccessMessage](
			httpClient,
		...
		changePasswordVerifyMFA: connect.NewClient[backend.VerifyMFARequest, backend.VerifyMFAResponse](
			httpClient,
			baseURL+AuthServiceChangePasswordVerifyMFAProcedure,
			connect.WithSchema(authServiceMethods.ByName("ChangePasswordVerifyMFA")),
			connect.WithClientOptions(opts...),
		),
		requestPasswordReset: connect.NewClient[backend.RequestPasswordResetRequest, proto_gen_go.SuccessMessage](
			httpClient,
			baseURL+AuthServiceRequestPasswordResetProcedure,
			connect.WithSchema(authServiceMethods.ByName("RequestPasswordReset")),
			connect.WithClientOptions(opts...),
		),
		resetPassword: connect.NewClient[backend.ResetPasswordRequest, backend.ResetPasswordResponse](
			httpClient,
			baseURL+AuthServiceResetPasswordProcedure,
			connect.WithSchema(authServiceMethods.ByName("ResetPassword")),
			connect.WithClientOptions(opts...),
		),
		resetPasswordRequestMFACode: connect.NewClient[backend.RequestMFACodeRequest, proto_gen_go.SuccessMessage](
			httpClient,
		...
		resetPasswordVerifyMFA: connect.NewClient[backend.VerifyMFARequest, backend.VerifyMFAResponse](
			httpClient,
			baseURL+AuthServiceResetPasswordVerifyMFAProcedure,
			connect.WithSchema(authServiceMethods.ByName("ResetPasswordVerifyMFA")),
			connect.WithClientOptions(opts...),
		),
		requestMFACode: connect.NewClient[backend.RequestMFACodeRequest, proto_gen_go.SuccessMessage](
			httpClient,
			baseURL+AuthServiceRequestMFACodeProcedure,
			connect.WithSchema(authServiceMethods.ByName("RequestMFACode")),
			connect.WithClientOptions(opts...),
		),
		verifyMFA: connect.NewClient[backend.VerifyMFARequest, backend.VerifyMFAResponse](
			httpClient,
...
type authServiceClient struct {
	register                     *connect.Client[backend.RegisterRequest, proto_gen_go.SuccessMessage]
	login                        *connect.Client[backend.LoginRequest, backend.LoginResponse]
	changePassword               *connect.Client[backend.ChangePasswordRequest, backend.ChangePasswordResponse]
	changePasswordRequestMFACode *connect.Client[backend.RequestMFACodeRequest, proto_gen_go.SuccessMessage]
	changePasswordVerifyMFA      *connect.Client[backend.VerifyMFARequest, backend.VerifyMFAResponse]
	requestPasswordReset         *connect.Client[backend.RequestPasswordResetRequest, proto_gen_go.SuccessMessage]
	resetPassword                *connect.Client[backend.ResetPasswordRequest, backend.ResetPasswordResponse]
	resetPasswordRequestMFACode  *connect.Client[backend.RequestMFACodeRequest, proto_gen_go.SuccessMessage]
	resetPasswordVerifyMFA       *connect.Client[backend.VerifyMFARequest, backend.VerifyMFAResponse]
	requestMFACode               *connect.Client[backend.RequestMFACodeRequest, proto_gen_go.SuccessMessage]
	verifyMFA                    *connect.Client[backend.VerifyMFARequest, backend.VerifyMFAResponse]
...
func (c *authServiceClient) Register(ctx context.Context, req *connect.Request[backend.RegisterRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
	return c.register.CallUnary(ctx, req)
}

// Login calls backend.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[backend.LoginRequest]) (*connect.Response[backend.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// ChangePassword calls backend.AuthService.ChangePassword.
func (c *authServiceClient) ChangePassword(ctx context.Context, req *connect.Request[backend.ChangePasswordRequest]) (*connect.Response[backend.ChangePasswordResponse], error) {
	return c.changePassword.CallUnary(ctx, req)
}

// ChangePasswordRequestMFACode calls backend.AuthService.ChangePasswordRequestMFACode.
func (c *authServiceClient) ChangePasswordRequestMFACode(ctx context.Context, req *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
...
func (c *authServiceClient) ChangePasswordVerifyMFA(ctx context.Context, req *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error) {
	return c.changePasswordVerifyMFA.CallUnary(ctx, req)
}

// RequestPasswordReset calls backend.AuthService.RequestPasswordReset.
func (c *authServiceClient) RequestPasswordReset(ctx context.Context, req *connect.Request[backend.RequestPasswordResetRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
	return c.requestPasswordReset.CallUnary(ctx, req)
}

// ResetPassword calls backend.AuthService.ResetPassword.
func (c *authServiceClient) ResetPassword(ctx context.Context, req *connect.Request[backend.ResetPasswordRequest]) (*connect.Response[backend.ResetPasswordResponse], error) {
	return c.resetPassword.CallUnary(ctx, req)
}

// ResetPasswordRequestMFACode calls backend.AuthService.ResetPasswordRequestMFACode.
func (c *authServiceClient) ResetPasswordRequestMFACode(ctx context.Context, req *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
...
func (c *authServiceClient) ResetPasswordVerifyMFA(ctx context.Context, req *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error) {
	return c.resetPasswordVerifyMFA.CallUnary(ctx, req)
}

// RequestMFACode calls backend.AuthService.RequestMFACode.
func (c *authServiceClient) RequestMFACode(ctx context.Context, req *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
	return c.requestMFACode.CallUnary(ctx, req)
}

// VerifyMFA calls backend.AuthService.VerifyMFA.
func (c *authServiceClient) VerifyMFA(ctx context.Context, req *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error) {
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[backend.RegisterRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.AuthService.Register is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[backend.LoginRequest]) (*connect.Response[backend.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) ChangePassword(context.Context, *connect.Request[backend.ChangePasswordRequest]) (*connect.Response[backend.ChangePasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.AuthService.ChangePassword is not implemented"))
}

func (UnimplementedAuthServiceHandler) ChangePasswordRequestMFACode(context.Context, *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
...
func (UnimplementedAuthServiceHandler) ChangePasswordVerifyMFA(context.Context, *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error) {
...
func (UnimplementedAuthServiceHandler) RequestPasswordReset(context.Context, *connect.Request[backend.RequestPasswordResetRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
...
func (UnimplementedAuthServiceHandler) ResetPassword(context.Context, *connect.Request[backend.ResetPasswordRequest]) (*connect.Response[backend.ResetPasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.AuthService.ResetPassword is not implemented"))
}

func (UnimplementedAuthServiceHandler) ResetPasswordRequestMFACode(context.Context, *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
...
func (UnimplementedAuthServiceHandler) ResetPasswordVerifyMFA(context.Context, *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error) {
...
func (UnimplementedAuthServiceHandler) RequestMFACode(context.Context, *connect.Request[backend.RequestMFACodeRequest]) (*connect.Response[proto_gen_go.SuccessMessage], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.AuthService.RequestMFACode is not implemented"))
}

func (UnimplementedAuthServiceHandler) VerifyMFA(context.Context, *connect.Request[backend.VerifyMFARequest]) (*connect.Response[backend.VerifyMFAResponse], error) {
