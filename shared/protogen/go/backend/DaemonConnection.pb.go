...
func (x *BlockedFile) Reset() {
	*x = BlockedFile{}
	mi := &file_backend_DaemonConnection_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlockedFile) Descriptor() ([]byte, []int) {
	return file_backend_DaemonConnection_proto_rawDescGZIP(), []int{3}
}
...
func (x *Server) Reset() {
	*x = Server{}
	mi := &file_backend_DaemonConnection_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Server) Descriptor() ([]byte, []int) {
	return file_backend_DaemonConnection_proto_rawDescGZIP(), []int{4}
}
...
const file_backend_DaemonConnection_proto_rawDesc = "" +
	...
	"\x03bid\x18\a \x01(\tR\x03bid2\x8c\x03\n" +
...
var file_backend_DaemonConnection_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_backend_DaemonConnection_proto_depIdxs = []int32{
	...
	7, // 3: backend.DaemonConnectionService.CreateBackendToken:input_type -> common.SimpleIDMessage
	1, // 4: backend.DaemonConnectionService.RegisterDaemon:input_type -> backend.RegisterDaemonRequest
	8, // 5: backend.DaemonConnectionService.SyncBlueprints:input_type -> common.Empty
	7, // 6: backend.DaemonConnectionService.GetBlueprint:input_type -> common.SimpleIDMessage
	8, // 7: backend.DaemonConnectionService.SyncServers:input_type -> common.Empty
	7, // 8: backend.DaemonConnectionService.GetServer:input_type -> common.SimpleIDMessage
	0, // 9: backend.DaemonConnectionService.CreateBackendToken:output_type -> backend.CreateTokenResponse
	9, // 10: backend.DaemonConnectionService.RegisterDaemon:output_type -> common.SuccessMessage
	2, // 11: backend.DaemonConnectionService.SyncBlueprints:output_type -> backend.Blueprint
	2, // 12: backend.DaemonConnectionService.GetBlueprint:output_type -> backend.Blueprint
	4, // 13: backend.DaemonConnectionService.SyncServers:output_type -> backend.Server
	4, // 14: backend.DaemonConnectionService.GetServer:output_type -> backend.Server
